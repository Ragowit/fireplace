...
class HearthState:
    ...
    def GetMoves(self):
        ...
        if self.game is None and len(self.deck1) == 30 and len(self.deck2) == 30:
            ...
            # Ice Block, Lord Jaraxxus, Illidan Stormrage, Sludge Belcher
            exclude = ["EX1_295", "EX1_323", "EX1_614", "FP1_012"]
            ...
            if len(self.deck1) < 30:
                ...
                owned_cards.extend(["CS2_231", "EX1_008", "CS2_146", "EX1_004", "EX1_393", "NEW1_018", "EX1_162",
                                    ...
                                    "EX1_595", "EX1_093", "NEW1_022", "EX1_023", "EX1_284", "CS1_069", "CS2_151",
                                    "CS2_221", "EX1_028", "EX1_283", "EX1_583"])
